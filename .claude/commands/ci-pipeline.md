...
The repo's CI (.github/workflows/ci.yml) builds and tests the main app. Keep it fast-failing on the things this repo has actually broken before: dependency vulnerabilities, build breakage across the three modes, and server boot errors.

Ensure the workflow, on push/PR:
