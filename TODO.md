...
| 14 | `/refactor-app-shell` | 🟡 Started | Badges and Leaderboard extracted to `src/components/screens/` (App.jsx 1310 → 1256 lines), pattern established and verified. Remaining screens to extract: settings, shop, ask-chat, scan/mark, plans/paywall, dashboard, quiz engine (largest, do last). |
