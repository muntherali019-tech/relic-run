...
//
// The list below is not a breach corpus. A real deployment should check against
// one (Have I Been Pwned's range API is the usual choice, and it never sends the
// password), but that is a network call on the signup path and a dependency
// decision, so it is out of scope here. This catches the passwords that actually
// dominate credential-stuffing lists, which is most of the value for none of the
// cost.
